...
import { useLookups, createLookup, patchLookupAskingPrice, type Lookup } from "@/hooks/useLookups";
...
export function ResearchPageClient() {
  ...
  async function handleReady(attrs: CardAttributes, estimate: ValueEstimate | null) {
      ...
      {result ? (
        <div className="flex flex-col gap-6">
          <div className="rounded-xl border border-border bg-paper p-4">
            ...
            {result.value_estimate_detail && <ValueEstimateBreakdown estimate={result.value_estimate_detail} />}
          </div>
